<?php
	...
	function loadAdminLeftMenu( $tpl, $params )
	{
		...
		$menu = array( 	array('url' => 'admin/general', 		'css_class' => (($tab === 'general')? ' selected' : ''), 		'title' => $page->lang('admmenu_general') ),
				array('url' => 'admin/pluginstaller', 'css_class' => (($tab === 'pluginstaller')? ' selected' : ''), 'title' => $page->lang('leftmenu_app') ),
				...
				array('url' => 'admin/deleteuser',		'css_class' => (($tab === 'deleteuser')? ' selected' : ''), 	'title' => $page->lang('admtitle_deleteuser') ),
				...
				//array('url' => 'admin/iprestrictions',	'css_class' => (($tab === 'iprestrictions')? ' selected' : ''), 'title' => $page->lang('admmenu_iprestrictions') ),
				array('url' => 'admin/plugins', 'css_class' => (($tab === 'plugins')? ' selected' : ''), 'title' => $page->lang('leftmenu_plugins') ),
				array('url' => 'admin/languages', 'css_class' => (($tab === 'languages')? ' selected' : ''), 'title' => $page->lang('leftmenu_lng'), 'tab_state' => $lang_updates ),
		);
